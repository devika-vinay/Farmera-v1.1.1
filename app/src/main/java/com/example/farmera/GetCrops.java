...
public class GetCrops extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String URL = "https://github.com/devika-vinay/Farmera-v1.1.1/blob/master/Data/crop_production.xls?raw=true";
...
//        }
        ...
        asyncHttpClient.get(URL, new FileAsyncHttpResponseHandler(this) {
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, File file) {
                Toast.makeText(GetCrops.this, "Unable to fetch complete data. Check your internet connection", Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    InputStream is = an.open("crops2015.xls");
