...
public class GetPests extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String URL = "https://github.com/devika-vinay/Farmera-v1.1.1/blob/master/Data/pestdata.xls?raw=true";
...
//        }
        ...
        asyncHttpClient2.get(URL, new FileAsyncHttpResponseHandler(this) {
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, File file) {
                Toast.makeText(GetPests.this, "Unable to fetch complete data. Check your internet.", Toast.LENGTH_SHORT).show();

                try {

                    AssetManager an = getAssets();
                    InputStream is = an.open("pestdata.xls");

                    workbook2 = Workbook.getWorkbook(is);
